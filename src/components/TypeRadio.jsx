        ...
        >
          ...
          <div
            className={`w-full h-fit border-2 flex flex-col gap-y-3 p-4 rounded-xl transition-all duration-300 
              ...
              ${selected === option.value ? "border-[#197686] bg-[#12464E]" : "border-[#197686] bg-transparent hover:border-[#197686]"}
              hover:bg-[#2C545B] hover:text-white`}
          >
            <span className="text-white font-semibold text-2xl">{option.amount}</span>
