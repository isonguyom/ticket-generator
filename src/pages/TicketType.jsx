  ...
  return (
    <Wrapper step={1} label="Ticket Selection">
      <div className="w-full md:bg-[#08252B] md:border md:border-[#0E464F] rounded-[32px] md:p-6">
        {/* Event Details */}
        <div className="text-[#fafafa] text-center border-2 border-[#07373F] bg-radial1 rounded-[24px] p-3 md:px-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            ...
            <div className="bg-[#052228] border border-[#07373F] rounded-[24px] mt-[8px] mb-[32px] p-4">
              ...
              />
              {ticketError && (
                <p className="text-red-400 text-sm mt-2">{ticketError}</p>
              )}
            </div>
          </div>
          ...
          <div>
            <label
              htmlFor="ticketCount"
              className="block text-[#fafafa] font-semibold mb-[8px]"
            >
              Number of Tickets
            </label>
            <select
